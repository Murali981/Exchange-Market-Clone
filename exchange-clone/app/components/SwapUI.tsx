            ...
            <div className="flex flex-col flex-1 gap-3 text-baseTextHighEmphasis">
              <div className="flex flex-col gap-3">
                <div className="flex items-center justify-between flex-row">
                  <p className="text-xs font-normal text-baseTextMedEmphasis text-white">
                    Available Balance
                  </p>
                  <p className="font-medium text-xs text-baseTextHighEmphasis text-white ">
                    36.94 USDC
                  </p>
                </div>
              </div>
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col relative">
                  <input
                    step="0.01"
                    placeholder="0"
                    className="h-12 rounded-lg border-2 text-white border-solid border-baseBorderLight bg-[var(--background)] pr-12 text-right text-2xl leading-9 text-[$text] placeholder-baseTextMedEmphasis ring-0 transition focus:border-accentBlue focus:ring-0"
                    type="text"
                    value="134.38"
                  />
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-col relative">
                <input
                  step="0.01"
                  placeholder="0"
                  className="h-12 rounded-lg text-white border-2 border-solid border-baseBorderLight bg-[var(--background)] pr-12 text-right text-2xl leading-9 text-[$text] placeholder-baseTextMedEmphasis ring-0 transition focus:border-accentBlue focus:ring-0"
                  type="text"
                  value="123"
                />
                <div className="flex flex-row absolute right-1 top-1 p-2">
              ...
              <div className="flex justify-end flex-row">
                <p className="font-medium pr-2 text-xs text-baseTextMedEmphasis text-white">
                  ≈ 0.00 USDC
                </p>
              </div>
              <div className="flex justify-center flex-row mt-2 gap-3">
                <div className="flex text-white items-center justify-center flex-row rounded-full px-[16px] py-[6px] text-xs cursor-pointer bg-baseBackgroundL2 hover:bg-baseBackgroundL3">
                  25%
                </div>
                <div className="flex text-white items-center justify-center flex-row rounded-full px-[16px] py-[6px] text-xs cursor-pointer bg-baseBackgroundL2 hover:bg-baseBackgroundL3">
                  50%
...
function LimitButton({ type, setType }: { type: string; setType: any }) {
  return (
    ...
    >
      <div
        className={`text-sm font-medium py-1 border-b-2 text-white ${
          type === "limit"
...
function BuyButton({
  ...
  return (
    ...
    >
      <p className="text-center text-sm font-semibold text-greenText text-white">
        Buy
      </p>
    </div>
  );
...
function SellButton({
  ...
  return (
    ...
    >
      <p className="text-center text-sm font-semibold text-redText text-white">
        Sell
      </p>
    </div>
  );
